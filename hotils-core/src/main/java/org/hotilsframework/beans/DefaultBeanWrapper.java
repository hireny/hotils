...
/**
 * Bean包装的实现类
 * @ClassName: DefaultBeanWrapper
 * @Author: hireny
 * @Date: Created in 2020-02-01 22:55
 * @Version: 1.0
 */
public class DefaultBeanWrapper implements BeanWrapper, Serializable {
     ...
     * @param beanClass
     */
    public DefaultBeanWrapper(Class<?> beanClass) {
     ...
     * @return
     */
    private DefaultBeanWrapper init() {
    ...
    private DefaultBeanWrapper.PropDescriptor createPropDescriptor(Field field) {
        final String fieldName = field.getName();
        final Class<?> fieldType = field.getType();
        final boolean isBooleanField = NumberUtils.isBoolean(fieldType);
