 ...
 * 搞得太复杂,算了
 */
public class WeakReferenceProvider<T> extends AbstractObjectProvider implements ObjectRegistry {
    ...
    public WeakReferenceProvider(int size) {
        this(size, new DefaultValidator());
    }

    public WeakReferenceProvider(int size, Validator validator) {
        super();
        this.size = size;
