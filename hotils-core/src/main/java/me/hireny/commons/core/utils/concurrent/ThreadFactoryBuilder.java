...
import me.hireny.commons.core.design.Builder;
...
public class ThreadFactoryBuilder implements Builder<ThreadFactory> {
    ...
    public ThreadFactoryBuilder setPriority(int priority) {
        if (priority < Thread.MIN_PRIORITY) {
            throw new IllegalArgumentException(Strings.format("Thread priority ({}) must be >= {}", priority, Thread.MIN_PRIORITY));
        }
        if (priority > Thread.MAX_PRIORITY) {
            throw new IllegalArgumentException(Strings.format("Thread priority ({}) must be <= {}", priority, Thread.MAX_PRIORITY));
        }
