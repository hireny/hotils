...
import me.hireny.commons.core.io.ResourceConstants;
 ...
 * @Author: hireny
 * @Date: Create in 2019/12/01 14:07
 * @Description: TODO   Socket通讯配置
 */
public class SocketConfiguration implements Serializable {
    private static final long serialVersionUID = 743001246594749058L;
     ...
     * 读取缓存大小
     */
    private int readBufferSize = ResourceConstants.DEFAULT_BUFFER_SIZE;
    /**
     * 写出缓存大小
     */
    private int writeBufferSize = ResourceConstants.DEFAULT_BUFFER_SIZE;
