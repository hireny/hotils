...
/**
 * @ClassName: ExecutorBuilder
 * @Author: hireny
 * @Date: Create in 2019/12/07 01:48
...
public class ExecutorBuilder implements Builder<ThreadPoolExecutor> {
    ...
    private static ThreadPoolExecutor build(ExecutorBuilder builder) {
        ...
        RejectedExecutionHandler handler = Objects.defaultIfNull(builder.handler, new ThreadPoolExecutor.AbortPolicy());
