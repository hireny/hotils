...
public class ObjectUtils {
    ...
    public static boolean isEmpty(Object o) {
        ...
        if (o instanceof java.util.Optional) {
            ...
            return !((java.util.Optional<?>) o).isPresent();
    ...
    public static Object unwrapOptional(Object obj) {
        if (obj instanceof java.util.Optional) {
            ...
            // 不支持多级可选用法
            Assert.checkArgument(!(result instanceof java.util.Optional), "Multi-level Optional usage not supported");
            return result;
        }
        if (obj instanceof org.hotilsframework.lang.Optional) {
            ...
            Object result = optional.get();
            Assert.checkArgument(!(result instanceof org.hotilsframework.lang.Optional), "Multi-level Optional usage not supported");
            return result;
        }
        return obj;
    }
...
//        if ()
    ...
    public static String lenientToString(Object o) {
        try {
            ...
            Logger.getLogger("org.hotilsframework.lang.StringUtils")
