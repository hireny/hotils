 ...
 * @Version: 1.0
 */
public class BeanWrapperImpl implements Serializable {
    private static final long serialVersionUID = -5169341437810067661L;

    private final Object target;
    private final Class<?> targetClass;

    public BeanWrapperImpl(Object target, Class<?> targetClass) {
        this.target = target;
    ...
    public static BeanWrapperImpl of(Object source) {
        return new BeanWrapperImpl(source, source.getClass());
    }
}
